...
from fuyu_utils import ScanNetFrameCaptionDataset, Scan2CapSimpleDataset, SceneCaptionDataset
...
def main(dataset_name: str):
    ...
    for i in tqdm(range(len(dataset))):
        ...
        boxes_count.append(num_boxes)

    print(f"Dataset: {dataset_name}")
    print("Average nouns count:", np.mean(nouns_count))
    print("Average boxes count:", np.mean(boxes_count))
