...
from utils_vote2cap.box_util import (flip_axis_to_camera_np, flip_axis_to_camera_tensor,
                            get_3d_box_batch_np, get_3d_box_batch_tensor)
from utils_vote2cap.pc_util import scale_points, shift_scale_points
...
class ScannetDatasetConfig(object):
    def __init__(self):
        ...
        self.num_semcls = self.num_class
        self.num_angle_bin = self.num_heading_bin
