...
SCAN_FAMILY_BASE = "/scratch2/generalvision/yangdejie/data/scanfamily/" # dummy
MASK_BASE = "../SVC/save_mask/"
...
def load_scannet(scan_ids, pc_type, load_inst_info):
    ...
    for scan_id in scan_ids:
        ...
        # load pcd data
        pcd_data = torch.load(os.path.join("../SVC", "pcd_with_global_alignment", '%s.pth'% scan_id))
...
if __name__ == '__main__':
    ...
    json.dump(scene_bbox_view_map, open("scene_bbox_view_map_for_valtest_mask3d.json", "w"))
    # json.dump(scene_bbox_info, open("scene_bbox_info_for_valtest_mask3d.json", "w"))
    pickle.dump(scene_bbox_info, open("scene_bbox_info_for_valtest_mask3d.pkl", "wb"))
